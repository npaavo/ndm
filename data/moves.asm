...
MoveEnd:
	...
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,    85, 2
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        55, NORMAL,   100, 5
	...
	move BIND,         TRAPPING_EFFECT,             15, NORMAL,    75, 3
	...
	move ACID,         DEFENSE_DOWN_SIDE_EFFECT,    40, POISON,   100, 4
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, NORMAL,    75, 2
	move LICK,         PARALYZE_SIDE_EFFECT2,       20, GHOST,    100, 5
	move SMOG,         POISON_SIDE_EFFECT2,         20, POISON,    70, 5
	move SLUDGE,       POISON_SIDE_EFFECT2,         65, POISON,   100, 4
	...
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             40, BUG,      100, 3
	...
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, NORMAL,   100, 2
	...
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,   100, 2
	...
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        75, ROCK,      90, 2
	...
	move DRAGONFIRE,   BURN_SIDE_EFFECT1,  			70, DRAGON,	  100, 3
	move DIRE_STING,   BURN_SIDE_EFFECT2,  			60, BUG,	  100, 3
	move VAMPIRE_BITE, DRAIN_HP_EFFECT,  		   110, BUG,	  100, 1
	move CHILLY_GUST,  SPEED_DOWN_SIDE_EFFECT,      40, ICE,	  100, 5
	move FIREBALL,     BURN_SIDE_EFFECT1,           70, FIRE,	  100, 3
	move CORRODE,      DEFENSE_DOWN_SIDE_EFFECT,    90, POISON,	  100, 2
	move CORRODE,      DEFENSE_DOWN_SIDE_EFFECT,    90, POISON,	  100, 2
	...
	move BUG_OUT, 	   FLINCH_SIDE_EFFECT1,	   		40, BUG,	  100, 4
