...
InternalMapEntries:
	...
	IMAP ROCK_TUNNEL_1F,                $E,$4,RockTunnelName
	IMAP POWER_PLANT,                   $F,$3,PowerPlantName
	...
	IMAP POKEMON_TOWER_7F,              $F,$6,PokemonTowerName
