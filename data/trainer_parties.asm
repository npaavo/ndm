...
WyldaData:
	...
	db $FF,20,IVYSAUR,22,ODDISH,0
	db $FF,28,IVYSAUR,29,GLOOM, 29,WEEPINBELL,0
	db $FF,35,VENUSAUR,32,GLOOM,36,WEEPINBELL,0
	db $FF,42,VENUSAUR,40,VILEPLUME,44,VICTREEBEL,0
	db $FF,47,VENUSAUR,46,VILEPLUME,48,VICTREEBEL,0
	db $FF,52,VENUSAUR,46,VILEPLUME,48,VICTREEBEL,49,EXEGGUTOR,0
	db $FF,58,VENUSAUR,57,VILEPLUME,59,VICTREEBEL,60,EXEGGUTOR,0 