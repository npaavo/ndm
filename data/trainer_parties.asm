...
; Pewter Gym - MOD 
IF DEF(_RED)
	db $FF,12,ODDISH,11,SPEAROW,12,VULPIX,13,SQUIRTLE,0
	db $FF,12,VULPIX,11,SPEAROW,12,POLIWAG,13,BULBASAUR,0
	db $FF,12,POLIWAG,11,SPEAROW,12,ODDISH,13,CHARMANDER,0
ENDC 
IF DEF(_BLUE) ; dbg
...
BrockData:
	db $FF,2,GEODUDE,2,ONIX,0
	db $FF,3,GEODUDE,3,ONIX,0
	db $FF,4,GEODUDE,4,ONIX,0
	db $FF,5,GEODUDE,5,ONIX,0
	db $FF,6,GEODUDE,6,ONIX,0
	db $FF,7,GEODUDE,7,ONIX,0
	db $FF,8,GEODUDE,8,ONIX,0
	db $FF,9,GEODUDE,9,ONIX,0
MistyData:
...
WyldaData:
	db $FF,12,BULBASAUR,14,ODDISH,0 ; 0 badge
	db $FF,20,IVYSAUR,22,ODDISH,0 ; 1 badge
	db $FF,28,IVYSAUR,29,GLOOM,29,WEEPINBELL,0 ; 2 badge
	db $FF,35,IVYSAUR,32,GLOOM,36,VICTREEBEL,0 ; 3 badge
	db $FF,42,VENUSAUR,40,VILEPLUME,44,VICTREEBEL,0 ; 4 badge
	db $FF,47,VENUSAUR,46,VILEPLUME,48,VICTREEBEL,0 ; 5 badge
	db $FF,52,VENUSAUR,52,VILEPLUME,50,VICTREEBEL,53,EXEGGUTOR,0 ; 6 badge
	db $FF,58,VENUSAUR,57,VILEPLUME,59,VICTREEBEL,60,EXEGGUTOR,0 ; 7 badge
	db $FF,62,VENUSAUR,63,VILEPLUME,63,VICTREEBEL,64,PARASECT,65,EXEGGUTOR,0 ;all badges owned, only encountered in rematch.
