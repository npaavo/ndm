...
; if first byte != FF, then
	...
	;
	; Slot1: L6-14, for 0-1 badges. unevolved mons 
	; Slot2: L14-20, for 2 badges. 3-stage mons evolved once. 2-stage stone mons evolved.
	; Slot3: L20-26, for 3 badges. 2-stage evolved, 3-stage still middle
	; Slot4: L26-30+, for 4+ badges. all mons fully evolved.
...
BugCatcherData: ; bugs
	...
	db 1,BEEDRILL,	BUTTERFREE,	VENONAT,	BEEDRILL,	BUTTERFREE,	PINSIR,		SCYTHER,	PARAS,0
...
SuperNerdData: ; Weird dual-types 
	...
	db 1,SLOWBRO,	GLOOM,		HAUNTER, 	EXEGGUTOR, 	OMASTAR, 	DRAGONAIR, 	VENOMOTH,	PORYGON,0
...
Green1Data: ; RIVAL
	...
	db 1,ARCANINE,	GYARADOS,	MACHOKE,	KADABRA,	GRAVELER, 	HAUNTER, 	EXEGGUTOR,  DRAGONAIR,0
...
GiovanniData: ;TODO: mod to Atticus, Fuchsia gym leader
	...
	db $FF,26,TAUROS,26,SCYTHER,26,RHYDON,26,CHANSEY,26,KANGASKHAN,26,RAPIDASH,0 ; 2 badges
...
WyldaData: ; Viridian gym leader, growth-themed
	...
	db $FF,26,BEEDRILL,26,PARASECT,26,EXEGGUTOR,26,VILEPLUME,26,VENUSAUR,26,VICTREEBEL,0 ; 2 badges
...
TobiasData: ; Cerulean gym leader, speed themed
	db $FF,10,VOLTORB,10,ELECTABUZZ,10,AERODACTYL,10,DIGLETT,10,TAUROS,10,SCYTHER,0 ; 0 badge
	db $FF,20,ELECTRODE,20,JOLTEON,20,AERODACTYL,20,DODRIO,20,PERSIAN,20,RAPIDASH,0 ; 1 badge
	db $FF,30,ELECTRODE,30,JOLTEON,30,AERODACTYL,30,DODRIO,30,PERSIAN,30,RAPIDASH,0 ; 2+ badges
