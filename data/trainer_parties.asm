...
; Route 3
	...
	db 13,SPEAROW,PIDGEY,PIKACHU,0
; Mt. Moon 1F
...
LassData:
; Route 3
	db 11,NIDORAN_F,BUTTERFREE,PIKACHU,0
	db 12,ODDISH,PSYDUCK,0
	db 13,CLEFAIRY,0
; Route 4
...
HikerData:
; Mt. Moon 1F
	db 11,GEODUDE,GROWLITHE,ONIX,0
; Mt Moon B2F
	db 12,SANDSHREW,DIGLETT,GEODUDE,0
	db 13,ONIX,0
; Route 25
...
PunkData:
;Route 3
	db 10,SANDSHREW,ZUBAT,MACHOP,0
	db 11,MANKEY,NIDORAN_M,EKANS,0
	db 12,BEEDRILL,GEODUDE,0
;Mt Moon
	db 13,CHARMANDER,CUBONE,MACHOP,0
	db 13,GEODUDE,NIDORAN_M,RATTATA,0
	db 14,POLIWAG,MANKEY,0
	db 15,PINSIR,0
; Vermilion Gym
...
; Route 22
IF DEF(_RED)
	db $FF,8,POLIWAG,9,SQUIRTLE,0
	db $FF,8,PIKACHU,9,BULBASAUR,0
	db $FF,8,VULPIX,9,CHARMANDER,0
ENDC 
IF DEF(_BLUE) ; dbg
	db $FF,2,POLIWAG,2,SQUIRTLE,0
	db $FF,2,PIKACHU,2,BULBASAUR,0
	db $FF,2,VULPIX,2,CHARMANDER,0
ENDC

; Pewter Gym - MOD 
IF DEF(_RED)
	db $FF,10,ODDISH,10,SPEAROW,10,VULPIX,13,SQUIRTLE,0
	db $FF,10,VULPIX,10,SPEAROW,10,POLIWAG,13,BULBASAUR,0
	db $FF,10,POLIWAG,10,SPEAROW,10,ODDISH,13,CHARMANDER,0
ENDC 
IF DEF(_BLUE) ; dbg
	db $FF,2,ODDISH,2,SPEAROW,2,VULPIX,2,SQUIRTLE,0
	db $FF,2,VULPIX,2,SPEAROW,2,POLIWAG,2,BULBASAUR,0
	db $FF,2,POLIWAG,2,SPEAROW,2,ODDISH,2,CHARMANDER,0
ENDC

; Cerulean ;??? maybe I won't use this
...
WyldaData:
	db 12,BULBASAUR,ODDISH,0 ; 0 badge
	db 16,IVYSAUR,ODDISH,0 ; 1 badge
	db 25,IVYSAUR,GLOOM,WEEPINBELL,0 ; 2 badge
	db 31,IVYSAUR,GLOOM,VICTREEBEL,0 ; 3 badge
	db 37,VENUSAUR,VILEPLUME,VICTREEBEL,0 ; 4 badge
	db 43,VENUSAUR,VILEPLUME,VICTREEBEL,0 ; 5 badge
	db 50,VENUSAUR,VILEPLUME,VICTREEBEL,EXEGGUTOR,0 ; 6 badge
	db 56,VENUSAUR,VILEPLUME,VICTREEBEL,EXEGGUTOR,0 ; 7 badge
	db 63,VENUSAUR,VILEPLUME,VICTREEBEL,PARASECT,EXEGGUTOR,0 ;all badges owned, only encountered in rematch.
BrockData:
	db 12,GEODUDE,ONIX,0 ; 0 badge
	db 16,GEODUDE,ONIX,0 ; 1 badge
	db 25,GRAVELER,RHYHORN,ONIX,0 ; 2 badge
	db 31,GRAVELER,RHYHORN,ONIX,0 ; 3 badge
	db 37,GOLEM,RHYDON,ONIX,0 ; 4 badge
	db 43,GOLEM,RHYDON,ONIX,0 ; 5 badge
	db 50,GOLEM,KABUTOPS,RHYDON,ONIX,0 ; 6 badge
	db 56,GOLEM,KABUTOPS,RHYDON,ONIX,0 ; 7 badge
	db 63,GOLEM,KABUTOPS,RHYDON,AERODACTYL,ONIX,0 ;all badges owned, only encountered in rematch.
MistyData:
