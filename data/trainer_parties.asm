...
BugCatcherData: ; bugs
	...
	db 1,BEEDRILL,	BUTTERFREE,	VENONAT,	BEEDRILL,	BUTTERFREE,	PINSIR,		SCYTHER,	PARASECT,0
	db 1,BEEDRILL,	BUTTERFREE, VENOMOTH,	PINSIR,		SCYTHER,	PINSIR,		SCYTHER,	PARASECT,0
...
JrTrainerFData: ; MOD: ADVENTURER (f), varied elemental teams (set B)
	...
	db 1,NIDORINA,	DODRIO,		MAROWAK, 	VOLTORB, 	PERSIAN, 	GOLDUCK, 	GLOOM,		NINETALES,0
	db 1,NIDOQUEEN,	DODRIO,		MAROWAK,	ELECTRODE, 	PERSIAN, 	GOLDUCK, 	VILEPLUME,	NINETALES,0
...
FisherData: ; fish mon
	...
	db 1,GOLDEEN,	SHELLDER,	SLOWPOKE, 	TENTACOOL, 	GYARADOS, 	HORSEA, 	OMANYTE,	KABUTO,0
	db 1,SEAKING,	CLOYSTER,	SLOWBRO, 	TENTACRUEL, GYARADOS, 	SEADRA, 	OMASTAR,	KABUTOPS,0
	
SwimmerData: ; sea mon (so many water types omg)

	db 1,HORSEA,	SHELLDER,	LAPRAS, 	STARYU, 	POLIWAG, 	PSYDUCK, 	TENTACOOL,	SQUIRTLE,0
	db 1,HORSEA,	SHELLDER,	LAPRAS, 	STARYU, 	POLIWHIRL, 	PSYDUCK, 	TENTACOOL,	WARTORTLE,0
	db 1,SEADRA,	CLOYSTER,	LAPRAS, 	STARMIE, 	POLIWRATH, 	GOLDUCK, 	TENTACRUEL,	BLASTOISE,0
	
CueBallData: ; MOD: Mystic, elemental mons and spirits

	db 1,VAPOREON,	BULBASAUR,	JOLTEON, 	CHARMANDER, FLAREON, 	SQUIRTLE, 	GASTLY,		GASTLY,0
	db 1,VAPOREON,	IVYSAUR,	JOLTEON, 	CHARMELEON, FLAREON, 	WARTORTLE, 	HAUNTER,	HAUNTER,0
	db 1,VAPOREON,	VENUSAUR,	JOLTEON, 	CHARIZARD, 	FLAREON, 	BLASTOISE, 	GENGAR,		GENGAR,0
...
PunkData: ;MOD: ToughGuy, varied elemental teams (set B)
	...
	db 1,SANDSHREW,	BEEDRILL,	ARBOK, 		MACHOKE, 	SPEAROW, 	PINSIR, 	WARTORTLE,		CUBONE,0
...
TamerData: ;TODO: mod to explorer, safari mons
	...
	db 1,SANDSHREW,	EKANS,		RHYHORN, 	NIDORINO, 	NIDORINA, 	MEOWTH, 	TAUROS,		KANGASKHAN,0
	db 1,SANDSLASH,	ARBOK,		RHYDON, 	NIDOKING, 	NIDOQUEEN, 	PERSIAN, 	TAUROS,		KANGASKHAN,0
...
Green1Data: ; RIVAL
	...
	db 1,GROWLITHE,	GYARADOS,	MACHOKE,	KADABRA,	GRAVELER, 	HAUNTER, 	EXEGGCUTE,  DRAGONAIR,0
	db 1,ARCANINE,	GYARADOS,	MACHAMP,	ALAKAZAM,	GOLEM, 		GENGAR, 	EXEGGUTOR,  DRAGONITE,0
	...
	; west of viridian early encounter, doubles down on countering your starter.
...
ScientistData:	 ;manmade / inorganic mons
	...
	db 1,MAGNEMITE,	VOLTORB,	KOFFING, 	MUK, 		PORYGON, 	PORYGON, 	DITTO,		DITTO,0
	db 1,MAGNETON,	ELECTRODE,	WEEZING, 	MUK, 		PORYGON, 	PORYGON, 	DITTO,		DITTO,0
...
CooltrainerMData: ; serious mons (set 1)
	...
	db 1,IVYSAUR,	CHARMELEON,	WARTORTLE,	DRAGONAIR,	KABUTO, 	HITMONCHAN, TAUROS,	NIDORINA,0
	db 1,VENUSAUR,	CHARIZARD,	BLASTOISE,	DRAGONITE,	KABUTOPS, 	HITMONCHAN, TAUROS,	NIDOQUEEN,0
	
CooltrainerFData: ; serious mons (set 2)

	db 1,JOLTEON,	FLAREON,	VAPOREON, 	DROWZEE,	RHYHORN, 	HITMONLEE, JYNX,	NIDORAN_M,0
	db 1,JOLTEON,	FLAREON,	VAPOREON,	DROWZEE,	RHYHORN, 	HITMONLEE, JYNX,	NIDORINO,0
	db 1,JOLTEON,	FLAREON,	VAPOREON,	HYPNO,		RHYDON, 	HITMONLEE, JYNX,	NIDOKING,0
...
GentlemanData: ;idc
	...
	db 1,GROWLITHE,	MAGMAR,	PIKACHU, 	SNORLAX,	POLIWAG,  	GLOOM, 		VULPIX,		PONYTA,0
...
ChannelerData: ; cultist
	...
	db 1,GASTLY,	HAUNTER,	GENGAR, 	ARBOK,	DITTO, 	TENTACOOL,	STARYU,		OMANYTE,0
	db 1,HAUNTER,	GENGAR,		GENGAR, 	ARBOK,	DITTO, 	TENTACRUEL,	STARMIE,	OMASTAR,0
