...
Green1Data: ; RIVAL
	...
	db $FF,8,VULPIX,8,POLIWAG,8,MACHOP,8,DROWZEE,8,GASTLY,8,DRATINI,0 ; 0 badge
	db $FF,16,VULPIX,16,GYARADOS,16,MACHOKE,16,KADABRA,16,HAUNTER,16,DRAGONAIR,0 ; 1 badge
...
LarsData: ; Pewter gym leader, mountain themed
	...
	db $FF,26,DUGTRIO,26,NIDOKING,26,GOLEM,26,MACHAMP,26,RHYDON,26,ONIX,0 ; 2 badges
...
TobiasData: ; Cerulean gym leader, speed themed
	...
	db $FF,26,ELECTRODE,26,JOLTEON,26,AERODACTYL,26,DODRIO,26,PERSIAN,26,RAPIDASH,0 ; 2 badges
...
BlaineData: ; Lavender town gym leader, TODO: mod to Aster, occultist
	...
	db $FF,26,STARMIE,26,ARBOK,26,VILEPLUME,26,TENTACRUEL,26,ALAKAZAM,26,GENGAR,0 ; 2 badges
...
ChannelerData: ; cultist
	...
	db 1,GASTLY,	HAUNTER,	HAUNTER, 	ARBOK,	DITTO, 	TENTACOOL,	STARYU,		OMANYTE,0
	db 1,HAUNTER,	HAUNTER,	GENGAR, 	ARBOK,	DITTO, 	TENTACRUEL,	STARMIE,	OMASTAR,0
