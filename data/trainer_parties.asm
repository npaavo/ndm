...
WyldaData:
	...
	db $FF,20,BEEDRILL,20,PARASECT,20,EXEGGCUTE,20,GLOOM,20,IVYSAUR,20,WEEPINBELL,0 ; 1 badge
	db $FF,30,BEEDRILL,30,PARASECT,30,EXEGGUTOR,30,VILEPLUME,30,VENUSAUR,30,VICTREEBEL,0 ; 2+ badge
LarsData:
	db $FF,10,DIGLETT,10,NIDORAN_M,10,GEODUDE,10,MACHOP,10,RHYHORN,10,ONIX,0 ; 0 badge
	db $FF,20,DUGTRIO,20,NIDORINO,20,GRAVELER,20,MACHOKE,20,RHYHORN,20,ONIX,0 
	db $FF,30,DUGTRIO,30,NIDOKING,30,GOLEM,30,MACHAMP,30,RHYDON,30,ONIX,0 
TobiasData:
	db $FF,10,VOLTORB,10,EEVEE,10,AERODACTYL,10,SPEAROW,10,MEOWTH,10,ELECTABUZZ,0 
	db $FF,20,ELECTRODE,20,JOLTEON,20,AERODACTYL,20,FEAROW,20,PERSIAN,20,ELECTABUZZ,0 
	db $FF,30,ELECTRODE,30,JOLTEON,30,AERODACTYL,30,FEAROW,30,PERSIAN,30,ELECTABUZZ,0 
LtSurgeData:
