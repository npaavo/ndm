...
; Viridian
ViridianCashierText::
	TX_MART RARE_CANDY, POKE_BALL, REPEL, POTION, SUPER_POTION, REVIVE, ETHER, ELIXER, FULL_HEAL, ANTIDOTE, SURFBOARD

; Pewter
PewterCashierText::
	TX_MART RARE_CANDY, ESCAPE_ROPE, POKE_BALL, POTION, SUPER_POTION, REVIVE, ETHER, ELIXER, FULL_HEAL, AWAKENING
