...
; Viridian
ViridianCashierText::
	TX_MART RARE_CANDY, POKE_BALL, REPEL, POTION, SUPER_POTION, REVIVE, ETHER, ELIXER, FULL_HEAL, ANTIDOTE, SURFBOARD, BICYCLE
...
; Bike shop
	TX_MART BICYCLE, SURFBOARD

; Vermilion
VermilionCashierText::
	TX_MART RARE_CANDY, SURFBOARD, ESCAPE_ROPE, POKE_BALL, POTION, FRESH_WATER, LEMONADE, ETHER, ELIXER, FULL_HEAL
