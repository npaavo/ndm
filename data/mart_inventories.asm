...
; Viridian
ViridianCashierText::
	TX_MART RARE_CANDY, POKE_BALL, REPEL, POTION, SUPER_POTION, HYPER_POTION, ETHER, ELIXER, FULL_HEAL, ANTIDOTE
...
; Cerulean
CeruleanCashierText::
	TX_MART RARE_CANDY, ESCAPE_ROPE, POKE_BALL, FRESH_WATER, ETHER, ELIXER, FULL_HEAL
