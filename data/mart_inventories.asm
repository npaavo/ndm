...
; Viridian
ViridianCashierText::
	TX_MART RARE_CANDY, POKE_BALL, POTION, SUPER_POTION, ANTIDOTE, PARLYZ_HEAL

; Pewter
PewterCashierText::
	TX_MART RARE_CANDY, POKE_BALL, POTION, SUPER_POTION, ESCAPE_ROPE, ANTIDOTE, FULL_HEAL

; Cerulean
CeruleanCashierText::
	TX_MART RARE_CANDY, POKE_BALL, POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL
